...
RSpec.describe "View a item's show page", type: :system, js: true, alma: true do
  ...
  context 'A special collections item' do
    ...
    before do
      ...
      stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005412600302486/holdings/22177450170002486/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
