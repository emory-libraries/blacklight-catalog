...
RSpec.configure do |config|
  ...
  config.before do
    ...
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9936550118202486/holdings/22360885950002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22360885950002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9936550118202486/holdings/22332597410002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22332597410002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9936550118202486/holdings/22319658770002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22360885950002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9937004854502486/holdings/22439796790002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22439796790002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9937004854502486/holdings/22394150340002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22394150340002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005988630302486/holdings/22171079010002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22171079010002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/123/holdings/22171079010002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22171079010002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/456/holdings/22171079010002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22171079010002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990016148150302486/holdings/22200365440002486/items?apikey=fakebibkey123")
      .to_return(status: 200, body: File.read(fixture_path + '/22200365440002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005059530302486/holdings/22172707720002486/items?apikey=fakebibkey123")
