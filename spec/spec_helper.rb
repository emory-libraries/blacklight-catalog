...
RSpec.configure do |config|
  ...
  config.before do
    ...
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9936550118202486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/9936550118202486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9936550118202486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=janeq")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/9936550118202486_w_user.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/9937004854502486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/9937004854502486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005988630302486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/990005988630302486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/123/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/990005988630302486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/456/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/990005988630302486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990016148150302486/holdings/22200365440002486/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/22200365440002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005059530302486/holdings/22172707720002486/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/22172707720002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990005059530302486/holdings/22172707740002486/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/22172707740002486.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990027507910302486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=janeq")
      .to_return(status: 200, body: File.read(fixture_path + '/alma_item_records/990027507910302486_w_user.xml'), headers: {})
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990027507910302486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
    ...
    stub_request(:get, "http://www.example.com/almaws/v1/bibs/990011434390302486/holdings/ALL/items?apikey=fakebibkey123&expand=due_date_policy&order_by=chron_i&user_id=GUEST")
