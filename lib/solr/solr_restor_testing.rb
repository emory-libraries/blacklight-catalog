...
def restore_collection
  ...
  url             =  "http://localhost:8983/solr/admin/collections?action=RESTORE&name=#{collection}&location=/mnt/#{short_hostname}_efs/solr/backup/&collection=blackcat_collection"
  uri             = URI.parse(url)
